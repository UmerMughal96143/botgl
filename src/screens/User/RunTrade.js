        ...
        <div className="container-fluid">
          <div className="row body-area mb-4">
            <div className="col-md-12 col-lg-12 col-xl-12">
              <div className="runtrade-content">
                <h1>Run Trade</h1>
                <div className="desc">
                  <p>We have selected the best arbitration for you</p>
                </div>
                <div className="row">
                    ...
                    <div className="row">
                      <div className="col-md-12 col-lg-12 col-xl-6">
                        <div className="box buy">
                          <div className="row">
                            <div className="col">
                              <h2 className="success">Buy</h2>
                            </div>
                            <div className="col text-right">
                              <p className="mb-0 grey-text">
                                {" "}
                                last updated:
                                <span className="grey-text last-updated">
                                  1 min ago
                                </span>
                              </p>
                            </div>
                          ...
                          <div className="row highlighted-stat">
                            <div className="col">
                              <div className="currency">
                                <span className="success">Kucoin</span>
                              </div>
                            </div>
                            <div className="col text-center">
                              <div className="percentage-change">
                            ...
                            <div className="col text-right">
                              <div className="amount">
                                <span className="success">$57,365,17</span>
                              </div>
                            </div>
                          </div>
                          <div className="row">
                      ...
                      <div className="col-md-12 col-lg-12 col-xl-6">
                        <div className="box sell">
                          ...
                          <div className="row highlighted-stat">
                            <div className="col">
                              <div className="currency">
                                <span className="danger">Currency</span>
                              </div>
                            </div>
                            <div className="col text-center">
                              <div className="percentage-change">
                            ...
                            <div className="col text-right">
                              <div className="amount">
                                <span className="danger">$57,365,17</span>
                              </div>
                            </div>
                          </div>
                          <div className="row">
                          ...
                          <div className="row">
                            ...
                            <div className="col text-center">
                              <div className="percentage-change">
                                <span>
                                  <i className="fal fa-chevron-circle-up  pr-2"></i>
                                  1,92%
                                </span>
                              </div>
                            </div>
                  ...
                  <div className="col-md-12  col-lg-12 col-xl-3">
                    <div className="box mb-2">
                      <div className="total-balance">
                        ...
                        <h3 className="pt-2">
                          BTC<span className="pl-2">0.203421</span>
                        </h3>
                      </div>
                    </div>
                    <div className="box my-purchase">
                      <div className="row">
                        <div className="col">
                          <h3 className="mb-0">My Purchase</h3>
                        </div>
                        <div className="col text-right">
                    ...
                    <div className="text-center purchase-sell-connect">
                      <svg
                    ...
                    <div className="box my-sell mb-2">
                      <div className="row">
                        <div className="col">
                          <h3 className="mb-0">My Sell</h3>
                        </div>
                        <div className="col text-right">
                      ...
                      <div className="col-md-12 p-0">
                        <div className="row">
                          <div className="col">
                            <div className="percentage-change">
                              <span>
                                <i className="fal fa-chevron-circle-down danger pr-2"></i>
                                2.48%
                              </span>
                            </div>
                          </div>
                    ...
                    <div className="box arbitration-values">
                      <h3 className="mb-0">Arbitration</h3>
                      <div className="row">
                        <div className="col">
                          <span>Value</span>
                        </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col text-right">
                          <div className="arbitration-percentage">
                            <span>1.90%</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="row text-center">
                        <div className="col">
                          <div className="circled-percentage">+1,90%</div>
                          <div className="btn-wrapper">
                            <button className="custom-btn ">Run Trade</button>
                          </div>
